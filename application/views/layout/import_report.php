...
<link rel="stylesheet" href="<?=base_url()?>assets/plugins/fontawesome/css/fontawesome-all.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/common.css" />
<script type="text/javascript" src="<?=base_url()?>assets/plugins/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/popper/popper.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/moment/moment.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/moment/ja.js"></script>
...
<link rel = "stylesheet" type = "text/css" href = "<?=base_url()?>assets/css/submission_report.css" />
